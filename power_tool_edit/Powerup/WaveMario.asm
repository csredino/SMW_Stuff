...
CODE_02A02C_2:  jmp CODE_02A02C

						
WaveExSprite:
                          LDA $9D 
CODE_029FB1:              BNE CODE_02A02C_2           
CODE_029FB3:              LDA $1715,X   
CODE_029FB6:              CMP $1c    
CODE_029FB8:              LDA $1729,X   
CODE_029FBB:              SBC $1d    
CODE_029FBD:              BEQ CODE_029FC5          
...
CODE_02A0F5:                      LDA $190F,X   ; \ Branch if takes 1 fireball to kill 
CODE_02A0F8:                      AND #$08                ;  | 
CODE_02A0FA:                      BEQ ChuckFireKill      ; / 
CODE_02A0FC:                      INC $1528,X             ; Increase times Chuck hit by fireball 
CODE_02A0FF:                      LDA $1528,X             ; \ If fire count >= 5, kill Chuck: 
CODE_02A102:                      CMP #$05                ;  | 
CODE_02A104:                      BCC FireRtNextSprite      ;  | 
...
FireballTiles:       db $5C,$6d,$5C,$6d,$6d,$5c,$6d,$5c	
