...
SuperBallMain:
		lda $187A
		BNE NoGenerateSuperBall
        lda $16
		and #$40
		beq NoGenerateSuperBall
		lda $74
		bne NoGenerateSuperBall		
        jsr	FindFreeSlot
		bmi NoGenerateSuperBall
		LDx $76
        lda XSpeed,x
		STA $174F,y	;Store into somespritetype's X speed
		lda $94
		clc
        adc Xpositionlo,x		
		sta $1727,y
...
DATA_029FA5:                      db $02,$02,$02,$02,$02,$02,$F8,$FC,$A0,$A4
...
SuperBallExSprite:
                          LDA $9D 
CODE_029FB1:              BNE ReturnExSprite 
                          lda $14
                          and #$07
						  bne DontReduceTimer
						  lda !BallTimer,x
...
CODE_029FFC:              STA $173d,X
                          ...
                          STA $1747,X
+          
CODE_02A00E:              BRA DontresetHitFlag  
         
NoObjContact: 
                          stz $175B,X            
DontresetHitFlag:         LDY #$00                
...
CODE_02A0D4:                 JSL $03B69f  
CODE_02A0D8:                 JSR CODE_02A547         
CODE_02A0DB:                 JSL $03B72b     
...
CODE_02A0ED:                 PLX                       ; / 
CODE_02A0EE:                 LDA $166E,X   ; \ Skip sprite if fire killing is disabled 
CODE_02A0F1:                 AND #$10               ;  | 
...
YDisplacement:       db $00,$00,$00,$00

FireballTiles:       db $3D,$3D,$3D,$3D

XDisplacement:       db $00,$00,$00,$00

FireballTileProp:    db $06,$46,$c6,$86
